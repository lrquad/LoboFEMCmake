...
public:
    ...
    {
        ImGui::Begin("Camera control", p_open,ImGuiWindowFlags_AlwaysAutoResize);
        ...
        ImGui::InputFloat("MouseSensitivity", &MouseSensitivity, 0.01f, 1.0f, "%.3f");
    ...
    void flythroughMoveMode()
    {
        ...
        if (!io.WantCaptureMouse)
        {
            ...
            {
                mouse_position.x = io.MousePos.x;
                mouse_position.y = io.MousePos.y;
            }
...
private:
    ...
    void updateCameraVectorsMeshlab()
    {
        ...
        // glm::mat3 model_T = glm::transpose(model);
        // Position = model_T*Position;
    }
